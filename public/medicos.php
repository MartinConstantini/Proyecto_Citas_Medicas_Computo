...
<html lang="es">
  ...
  <body class="bg-body-custom">
    ...
    <main class="container py-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
          ...
          <p class="text-muted small mb-0">lista de medicos registrados</p>
        </div>
        ...
        <div class="card-body">
          <table class="table table-sm align-middle mb-0">
            ...
            <tbody id="tabla-medicos">
              <tr><td colspan="7" class="text-center text-muted small">cargando...</td></tr>
            </tbody>
          </table>
        </div>
      </div>
    ...
    <div class="modal fade" id="modalAgregarMedico" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="form-agregar-medico" class="small">
            ...
            <div class="modal-body">
              <div class="row g-2">
                <div class="col-md-4">
                  ...
                  <input type="text" name="cedula" class="form-control input-soft" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                  ...
                  <input type="number" name="edad" class="form-control input-soft" min="18" required>
                </div>
                <div class="col-md-2">
    ...
    <div class="modal fade" id="modalEditarMedico" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="form-editar-medico" class="small">
            <div class="modal-header">
            ...
            <div class="modal-footer">
              <button type="button" id="btn-eliminar-medico" class="btn btn-outline-danger btn-sm">eliminar</button>
              <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal">cerrar</button>
